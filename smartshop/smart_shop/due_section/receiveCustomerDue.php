		 ...
		 if(!$db_select){
		  ...
		  $result_set= mysql_query($query,$connection);
		   if( mysql_num_rows($result_set)>0)
			   ...
			   if($new_amount<0){
					$message="More than due can not be taken";
			   }
			   else{
					$query ="UPDATE daily_item_sale SET
				...
				$message= "Sorry, Cannot Find the Sale_ID";
			}
...
<?php include("../includes/header.php"); ?>
	<div class="container">
		<div class="jumbotron">
		<h1>Recieve Due Money From Customer</h1>
	 ...
	 <div class="container">
		...
		<form class="form-signin" method="post" action="receiveCustomerDue.php">
        <h2 class="form-signin-heading">Enter Receiving Amount Details</h2>
