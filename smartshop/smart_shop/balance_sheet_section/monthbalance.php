...
<?php include("../includes/header.php"); ?>
	<div class="container">
		<div class="jumbotron">
		<h1>Show Last Months Balance</h1>
		
		<table>
		<caption>Sales Balance</caption>
		<?php
		$last_month_today = mktime(0,0,0,date("m")-1,date("d")+1,date("Y"));
		$last_month_today =date("Y-m-d", $last_month_today);
		//echo "last_month_today is ".$last_month_today;
		 ...
		 $user_id=$_SESSION['userId'];
		  ...
		  $query .= "AND C.date BETWEEN '{$last_month_today}' AND '{$date}' ";
		...
		?>
				...
				<caption>Other Cost</caption>
				 ...
				 $query= "SELECT A.description,A.date,A.paid_by,A.cost,B.name ";
					  ...
					  $query .= "WHERE A.userId = {$user_id} ";
					  $query .= "AND A.date BETWEEN '{$last_month_today}' AND '{$date}' ";
		...
		<table>
				 ...
				 <caption>Owner Assets</caption>
				  ...
				  $query .= "AND B.date BETWEEN '{$last_month_today}' AND '{$date}'  ";
